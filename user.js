class User {
  ...
  constructor() {
    ...
    if (
      (localStorageLogin == null || localStorageLogin == "none") &&
      (localStoragePassword == null || localStoragePassword == "none")
    ) {
  ...
  userExists() {
    if (
      (this.#login == null || this.#login == "none") &&
      (this.#password == null || this.#password == "none")
    ) {
      return false;
    } else {
      return true;
  ...
  setButton() {
    ...
    if (
      ...
      divAuthBtn.innerHTML +=
        "<button id='authBtn' onclick='LogInForm();'>Log In</button>";
      listOfContact.style.display = "none";
      sortForm.style.display = "none";
      navbartogglerbtn.style.display = "none";
    } else {
      divAuthBtn.innerHTML +=
        "<button id='authBtn' onclick='LogOutForm();'>Log Out</button>";
...
function LogInForm() {
  ...
  LogInFormDiv.innerHTML +=
    "    <div id='LogInForm' class='LogInOutForm'>" +
